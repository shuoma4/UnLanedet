...
MASK_SRC = "/data1/lxy_log/workspace/ms/OpenLane/dataset/raw/mask_cut_600"
MASK_DST = (
    "/data1/lxy_log/workspace/ms/OpenLane/dataset/raw/mask_cut_600_resized_800_320"
)
...
def main():
    ...
    with ThreadPoolExecutor(max_workers=32) as executor:
        list(
            tqdm(
                executor.map(process_mask, img_files),
                total=len(img_files),
                desc="Resizing Masks",
            )
        )
