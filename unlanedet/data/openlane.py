            ...
            try:
                ...
                sample = {
                    ...
                    "origin_img_path": osp.join(
                        osp.dirname(self.data_root), rel_file_path
                    ),
                    "lanes": lanes,
                    "lanes_3d": lanes_3d,
                ...
                sample["extrinsic"] = (
                    np.array(extrinsic, dtype=np.float32)
                ...
                pose = anno.get("pose")
                sample["pose"] = (
                    np.array(pose, dtype=np.float32) if pose is not None else None
                )
