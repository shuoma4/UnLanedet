...
train.output_dir = "./output/llanet/mobilenetv4_gsafpn_openlane/"
...
param_config.head_type = "LLANetHeadWithStaticsPriors"  # 带先验的网络头
...
param_config.generate_visualization = True  # 开启可视化
