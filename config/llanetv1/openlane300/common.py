...
def build_config(
    ...
    param_config.deploy_cfg = deploy_cfg or dict(enable_qat=False, enable_onnx_export=False)
    ...
    train.output_dir = f'output/llanetv1/openlane300/{run_name}'
    ...
    val_process = [
        L(BGR2RGB)(),
        L(OpenLaneGenerator)(transforms=VAL_TRANSFORMS, training=False, cfg=param_config),
        L(ToTensor)(keys=['img'], collect_keys=['img_path', 'lane_categories', 'lane_attributes', 'lane_track_ids']),
    ]
